...
export default function CollectionPage() {
  ...
  // Get unique characters from images
  const uniqueCharacters = Array.from(
    new Set(images.filter(img => img.character_name).map(img => img.character_name))
  ).sort() as string[]

  // Filter images by character
  const filteredImages = selectedCharacterFilter === "all"
    ? images
    : images.filter(img => img.character_name === selectedCharacterFilter)
  ...
  return (
    <div className="container mx-auto px-3 sm:px-4 py-6 sm:py-8">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              {!isSelectionMode ? (
                <>
                  ...
                  <Button onClick={() => router.push("/generate")} className="bg-[#1111FF] hover:bg-[#0e0ecc]">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-[#252525] border border-[#333] rounded-md px-3 py-1.5 text-sm text-white focus:ring-2 focus:ring-[#1111FF] focus:border-transparent"
                >
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="rounded border-[#333] bg-[#252525] text-[#1111FF] focus:ring-[#1111FF]"
                />
                <span className="text-sm text-gray-400">Show prompts</span>
              </label>
            </div>
      ...
      {isLoading ? (
        <GallerySkeleton count={8} className="grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4" />
      ) : images.length === 0 ? (
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
          {filteredImages.map((image) => (
            <Card
              key={image.id}
              className={`bg-[#1A1A1A] border-[#252525] overflow-hidden transition-all ${selectedImages.has(image.id) ? "ring-2 ring-[#1111FF] ring-offset-2 ring-offset-[#1A1A1A]" : ""
                }`}
            >
              <div
              ...
              >
                ...
                >
                  {selectedImages.has(image.id) ? (
                    <CheckCircle className="h-5 w-5 text-[#1111FF]" />
                  ) : (
          ...
          <div className="py-4">
            {isLoadingCollections ? (
              <div className="flex justify-center items-center h-32">
                <Loader2 className="h-6 w-6 animate-spin text-[#1111FF]" />
              </div>
              ...
              <div className="text-center py-4">
                ...
                <Button
                  ...
                  className="bg-[#1111FF] hover:bg-[#0e0ecc]"
                >
                  <FolderPlus className="h-4 w-4 mr-2" />
                  Create Collection
                </Button>
              ...
              <div className="space-y-2 max-h-[300px] overflow-y-auto pr-2">
                {collections.map((collection) => (
                  ...
                  >
                    <Folder className="h-4 w-4 mr-2 text-[#1111FF]" />
                    {collection.name}
        ...
        <DialogContent className="bg-[#1A1A1A] border-[#252525] w-[95vw] max-w-md mx-auto">
          ...
          <form onSubmit={handleCreateCollection}>
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isCreatingCollection} className="bg-[#1111FF] hover:bg-[#0e0ecc]">
