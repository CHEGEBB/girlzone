...
export default function DirectAdminSettingsPage() {
  ...
  useEffect(() => {
    const loadSettings = async () => {
      try {
        ...
        // Load settings using key-value structure (as per migration)
        const { data: adminSettingsData, error } = await supabase.from("admin_settings").select("*")
  ...
  const handleSaveSettings = async () => {
    try {
      ...
      // Save settings as key-value pairs (as per migration)
