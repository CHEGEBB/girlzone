                ...
                <div className="lg:col-span-1">
                  <div className="sticky top-6">
                    ...
                    <div className="space-y-4">
                      <div className="relative aspect-[3/4] w-full max-w-sm mx-auto bg-[#252525] rounded-xl overflow-hidden border-2 border-dashed border-[#333] hover:border-[#FF4D8D] transition-colors group">
                        <input
                          type="file"
                          ref={fileInputRef}
                          className="hidden"
                        ...
                        {isUploading && (
                          <div className="absolute inset-0 bg-black/70 flex items-center justify-center">
                            <div className="text-center">
                              <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#FF4D8D] mx-auto mb-3"></div>
