...
export default function AdminUsersPage() {
  ...
  const [filterRole, setFilterRole] = useState<"all" | "admin" | "user" | "premium">("all")
  ...
  const filteredUsers = users.filter((u) => {
    ...
    const matchesRole =
      ...
      (filterRole === "premium" && u.isPremium)
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium text-slate-600 dark:text-slate-400">Premium Users</CardTitle>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">Active subscribers</p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Select
              value={filterRole}
              onValueChange={(value: "all" | "admin" | "user" | "premium") => setFilterRole(value)}
            >
                    ...
                    >
                          ...
                          <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                              ...
                              {user.isPremium && (
                                <Badge
                                  variant="secondary"
                                  className="bg-gradient-to-r from-amber-200 to-yellow-400 text-yellow-900 border-none h-5 px-1.5"
                                >
                      ...
                      <td className="py-4 px-4">
                        <Badge
                          ...
                          className={user.isAdmin ? "bg-gradient-to-r from-purple-500 to-pink-500" : ""}
                        >
                          {user.isAdmin ? (
                            <>
                  ...
                  {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                    ...
                    return (
                      <Button
                        ...
                        className={currentPage === pageNum ? "bg-gradient-to-r from-purple-500 to-pink-500" : ""}
                      >
                        {pageNum}
                      </Button>
                    )
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Label htmlFor="edit-isAdmin" className="flex items-center space-x-2">
                <Shield className={`h-4 w-4 ${formData.isAdmin ? "text-purple-500" : ""}`} />
