        ...
        <div className="bg-[#1A1A1A] rounded-xl p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <Button
                type="submit"
                className="w-full bg-[#1111FF] hover:bg-[#0e0ecc] text-white py-5"
                disabled={isLoading}
              >
          ...
          <div className="mt-6 p-4 bg-blue-900/20 border border-blue-800 text-blue-300 rounded-lg">
            ...
            <Link href="/admin/manual-setup" className="text-[#1111FF] hover:underline flex items-center text-sm">
          ...
          <div className="mt-6 text-center text-sm">
            <p className="text-gray-400">
              ...
              <Link href="/admin/login" className="text-[#1111FF] hover:underline">
                Log in
              </Link>
            </p>
          </div>
