                ...
                <div key={i} className="flex-1 flex flex-col items-center">
                    <div
                        className={`w-8 h-8 flex items-center justify-center rounded-full border-2 text-sm font-bold transition-all duration-300  ${step === i
                            ? "bg-[#1111FF] border-[#1111FF] text-white"
                            : step > i
                                ? "bg-[#252525] border-[#1111FF] text-[#1111FF]"
                    ...
                    {i < steps.length - 1 && (
                        <div className="w-full h-1 bg-[#252525] mt-2 mb-2">
                            <div
                                className={`h-1 transition-all duration-300 ${step > i ? "bg-[#1111FF] w-full" : "bg-[#252525] w-0"
                                    }`}
                            />
                        </div>
                    )}
...
function Badge({ text }: { text: string }) {
    return (
        <span className="bg-[#252525] text-[#1111FF] rounded-full px-4 py-1 text-xs font-semibold mr-2 mb-2 inline-block">
            {text}
        </span>
    );
}
        ...
        <div className="max-w-xl mx-auto mt-12 bg-[#18181f] rounded-2xl shadow-2xl p-8 text-white font-sans">
            ...
            {step === 0 && (
                <div className="flex flex-col items-center justify-center min-h-[300px] w-full">
                  ...
                  ${selected === char.id
                                        ? "border-[#1111FF] bg-[#23232b] shadow-lg"
                                        : isMatch(char)
                                            ? "border-[#1111FF] bg-[#23232b] opacity-90"
                            ...
                            >
                                <img
                                    src={char.image}
                                    alt={char.name}
                                    className="w-16 h-16 rounded-full mb-2 object-cover border-2 border-[#1111FF]"
                                />
                    ...
                    <button
                        className="bg-[#1111FF] hover:bg-[#0e0ecc] text-white px-8 py-3 rounded-xl font-bold text-lg transition-all"
                        onClick={() => setStep(1)}
                    ...
                    <div className="bg-[#23232b] rounded-2xl p-8 shadow-lg w-full max-w-md flex flex-col items-center relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center">
                            <img
                                ...
                                className="w-24 h-24 rounded-full mb-4 object-cover border-4 border-[#1111FF] shadow-lg"
                            />
                            ...
                            <button
                                className="mt-6 bg-[#1111FF] hover:bg-[#0e0ecc] text-white px-8 py-3 rounded-xl font-bold text-lg transition-all"
                                onClick={() => setStep(0)}
                            >
                                Start Chat
                            </button>
            ...
            <div className="flex justify-between mt-8">
                ...
                {step < 5 && (
                    <button
                        className="flex items-center gap-2 px-6 py-2 rounded-lg bg-[#1111FF] text-white hover:bg-[#0e0ecc] transition-all font-bold"
